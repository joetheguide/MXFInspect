...
namespace Myriadbits.MXF
{
	...
	public class MXFTimedTextDataElement : MXFObject
	{
		...
		/// </summary>
		static MXFTimedTextDataElement()
		{
		...
		public MXFTimedTextDataElement(MXFReader reader, long rLength)
			: base(reader)
		{
			this.Length = rLength;
		...
		{
			return string.Format("Timed Text Data Element - Line {0}, Count {1}", this.LineNumber, this.PayloadSampleCount);
		}
	}
}
